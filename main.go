...
//
// This is the root main package that redirects to cmd/apibconv for the actual CLI implementation.
// For the full CLI implementation, see cmd/apibconv/main.go.
//
// # Usage
//
